...
export default async function OrderDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const statusLabels: Record<string, { label: string, style: string }> = {
        ...
        RETURNED: { label: 'İade Edildi', style: 'bg-orange-100 text-orange-700 border-orange-200' },
        CANCELLED: { label: 'İptal Edildi', style: 'bg-red-100 text-red-700 border-red-200' },
    }
